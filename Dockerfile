...
RUN apk add --no-cache nginx mysql-client supervisor curl bash redis imagemagick-dev
...
RUN chown -R deployer:www-data $WP_ROOT && chmod 640 $WP_ROOT/wp-config.php
